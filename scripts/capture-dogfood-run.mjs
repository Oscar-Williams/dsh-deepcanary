...
const bundle = {
  ...
  run: {
    ...
    taskFamily,
    scenario,
    pluginVersion: runtimeBundle?.run.pluginVersion ?? args.get('plugin-version') ?? '0.1.0-rc.4',
    runtimeTag: runtimeBundle?.run.runtimeTag ?? args.get('runtime-tag') ?? 'dsh-v0.1.2-alpha.4',
