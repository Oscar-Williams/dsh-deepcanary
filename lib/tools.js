...
const evidenceAuthorities = ['host', 'runtime', 'derived', 'heuristic'];
const attentionLevels = ['C1', 'C2', 'C3'];
export function registerTools(ctx, service) {
    ...
    register(defineTool({
        ...
        parameters: {
            ...
            severityHint: { type: 'integer', enum: [0, 1, 2, 3], description: 'Optional severity hint from the provider.' },
